                                        ...
                                        <Form onSubmit={handleSave}>
                                            ...
                                            {tipoUsuario === 'psicologo' && (
                                                <>
                                                    ...
                                                    <Form.Group>
                                                        <Form.Label>Tópicos (separe por ", ")</Form.Label>
                                                        <Form.Control
                                                            type="text"
                                                            name="tópicos"
                                                            value={perfil.especificidade}
                                                            onChange={(e) => setPerfil({ ...perfil, especificidade: e.target.value })}
                                                            placeholder='Digite os tópicos que prefere abordar em uma consulta'
                                                        />
                                                    </Form.Group>
                                                </>
                                            )}
                                        ...
                                        <>
                                            ...
                                            {tipoUsuario === 'psicologo' && (
                                                <>
                                                    ...
                                                    <hr />
                                                    <Row>
                                                        <Col sm={3}><h6 className="mb-0">Especialidades</h6></Col>
                                                        <Col sm={9} className="text-secondary">{perfil.especialidade}</Col>
                                                    </Row>
                                                    <hr />
                                                    <Row>
                                                        <Col sm={3}><h6 className="mb-0">Tópicos</h6></Col>
                                                        <Col sm={9} className="text-secondary">{perfil.especificidade}</Col>
                                                    </Row>
                                                    <hr />
                                                </>
                                            )}
